...
class TestHTTPRequests(unittest.TestCase):
    ...
    def test_default_operator_with_entry_return_value(self, mock_post):
        ...
        results = search_client.perform_search(search_service, search_operator,
                                               return_type)
    ...
    def test_query_group_after_2019_and_either_musculus_or_human(
        ...
        search_operator_two = text_operators.ExactMatchOperator(
            value="Mus musculus",
            attribute="rcsb_entity_source_organism.taxonomy_lineage.name")
        is_mus_query_node = search_client.QueryNode(search_service_two,
                                                    search_operator_two)
        ...
        search_operator_three = text_operators.ExactMatchOperator(
            value="Homo sapiens",
            attribute="rcsb_entity_source_organism.taxonomy_lineage.name")
        is_human_query_node = search_client.QueryNode(search_service_three,
                                                      search_operator_three)
